...
function LeftMenu() {
    ...
    const fetchWeatherData = async () => {
        try {
            const { data } = await axios.get(
                `https://api.openweathermap.org/data/2.5/weather?q=${city}&appid=8e6bed74c04b5e007c5319a037a08e8e&units=metric`
            );
            console.log(data);
            setWeatherData(data);
        } catch (error) {
    ...
    return (
        <>
            ...
            {/* Left menu with conditional class for mobile view */}
